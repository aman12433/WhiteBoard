...
#icon
image_icon = PhotoImage(file="white board images/logo.png")
root.iconphoto(False, image_icon)

color_box=PhotoImage(file="white board images/color section.png")
Label(root, image=color_box, bg="#f2f3f5").place(x=10, y=20)

eraser = PhotoImage(file="white board images/eraser.png")
Button(root, image=eraser, bg="#f2f3f5", command=new_canvas).place(x=30,y=400)

colors = Canvas(root, bg="#ffffff", width=37, height=306, bd=0)
